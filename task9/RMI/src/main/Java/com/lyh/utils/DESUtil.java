...
public class DESUtil {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        System.out.println("加密时间"+str1);
        long str2 = desUtil.decryptToLong(str1);
        System.out.println("解秘时间"+str2);
        String ser3 = desUtil.encrypt("鬼精");
        System.out.println("加密名字"+ser3);
        String ser4 = desUtil.decrypt(ser3);
        System.out.println("解秘名字"+ser4);
    }
}
