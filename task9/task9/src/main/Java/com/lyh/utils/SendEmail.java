...
public class SendEmail {
    ...
    //收件人
    //private final String rcpt_to = "2891368077@qq.com";
    //主题
    private String subject;
    //内容
    //private String html = "<html><p>hello world</p></html>";
    public SendEmail(){}
    public SendEmail(String url,String apiUser,String apiKey,String subject){
        this.url = url;
        this.apiUser = apiUser;
        this.apiKey = apiKey;
        this.subject = subject;
    }
    public  boolean send_common(String rcpt_to,String html) throws IOException {
        ...
        params.add(new BasicNameValuePair("fromName", "SendEmail"));
...
//        entity.addTextBody("fromName", "SendEmail", TEXT_PLAIN);
